...
/*
 * On Linux:
 *   gcc -shared -I/usr/include/python2.4 -I/usr/include/lame pylame3.c \
 *   -lmp3lame -o pylame3.so
 *
 * On Windows:
 * cl /LD /IC:\Python24\include /IC:\lame-3.96.1\include pylame3.c \
...
static int Encoder_init(pylame3_EncoderObject *self, PyObject *args, PyObject *kw) {
    PyObject *outfp;
